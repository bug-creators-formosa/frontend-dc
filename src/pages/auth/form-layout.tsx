      ...
      <div className="h-full border rounded-lg flex mx-auto lg:px-0 w-full lg:max-w-6xl xl:max-w-max overflow-hidden shadow-md">
        <section className="h-full w-full flex-shrink-1 hidden md:flex md:items-center xl:p-24">
          ...
          <img
            ...
            className="object-contain xl:min-w-[734px] xl:max-w-[900px]"
          />
        </section>
        <section className="flex bg-background flex-col justify-center gap-3 p-4 py-2 text-lg xl:w-2/3 md:px-10 w-full max-h-min min-w-[400px]">
          <Link to="/" className="flex items-center max-w-4xl">
            <h1 className="font-sans-accent text-5xl text-foreground">
              ComunidadActiva
            </h1>
          </Link>
          <Outlet />
